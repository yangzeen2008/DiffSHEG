...
| 配置 | batch_size | workers | 显存占用 | GPU利用率 | 每Epoch耗时 |
|------|-----------|---------|---------|----------|------------|
| 初始版 | 32 | 4 | 4 GB | 7~46% | ~10分钟 |
| 优化版 | 128 | 16 | 8 GB | ~58% | ~4分钟 |
| **极速版** | **256** | **32** | **31 GB** | **~88%** | **~1.5分钟** |
| 极限版 | 512 | 32 | 31 GB | ~92% | **~1分钟** |
