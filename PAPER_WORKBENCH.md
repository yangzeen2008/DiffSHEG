...
4. 新实验、新文献和章节复核分别使用 [实验记录模板](paper-workbench/templates/experiment-record.md)、[文献笔记模板](paper-workbench/templates/literature-note.md) 和 [章节审校模板](paper-workbench/templates/chapter-review.md)。
